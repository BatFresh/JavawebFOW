...
/**
 * Servlet implementation class DisplayFoodByfoodnameServlet
 */
@WebServlet("/DisplayFoodByfoodnameServlet")
public class DisplayFoodByfoodnameServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DisplayFoodByfoodnameServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			List foodlist = fs.browseByfoodname(foodname,storeid);
